...
# # Fake taxonomy categories for demo
...
#     file = request.files['file']
#     sequences = [line.strip() for line in file if line.strip()]
#     # Demo: Randomly assign each sequence a taxonomy label
...
# def analyze():
#     file = request.files['file']
#     # Decode file lines properly
#     sequences = [line.decode('utf-8').strip() for line in file if line.strip()]
    
#     print(f"Received {len(sequences)} sequences")  # Debug print
...
#     print(f"Taxonomy counts: {taxonomy_counts}")  # Debug print
